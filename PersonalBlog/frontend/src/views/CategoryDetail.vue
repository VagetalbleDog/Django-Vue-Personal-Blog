...
<BlogHeader/>
  ...
  <p style="text-align: left;padding-top: 70px;font-size: x-large"><span class="category" style="font-size: large">{{category_name}}</span>&nbsp;分类&nbsp;共{{info.count}}篇文章：</p>
...
<script>
    ...
    import getCategoryData from "@/composables/getCategoryData";
    ...
    export default {
      ...
      setup(){
        ...
        const category_name = router.currentRoute.value.params.category_name;
        getCategoryData(info,route,category_name);
        const {
          is_page_exists,
          get_page_param,
          get_path
